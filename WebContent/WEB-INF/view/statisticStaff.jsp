...
<div class="navbar navbar-expand-sm bg-white">
	<div class="navbar-text navbar-title"
		...
		<b> <s:message code="statistic.staff.title" />
		</b>
	</div>
</div>
		...
		<table class="table table-bordered table-hover">
			<thead>
				<tr class="text-center">
					<th><s:message code="statistic.staff.column1" /></th>
					<th><s:message code="statistic.staff.column2" /></th>
					<th><s:message code="statistic.staff.column3" /></th>
					<th><s:message code="statistic.staff.column4" /></th>
				</tr>
			</thead>
			<tbody>
